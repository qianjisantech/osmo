...
const TableNameGosmoTaskRecord = "gosmo_task_record"

// GosmoTaskRecord mapped from table <gosmo_task_record>
...
func (*GosmoTaskRecord) TableName() string {
	return TableNameGosmoTaskRecord
}
