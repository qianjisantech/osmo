...
parsing, reassembling tcp packets, handling communication with engine listeners(github.com/qianjisantech/yl-cwhsea-gbs-gosmo-agent/capture),
...
import "github.com/qianjisantech/yl-cwhsea-gbs-gosmo-agent/tcp"
...
*/
package tcp // import github.com/qianjisantech/yl-cwhsea-gbs-gosmo-agent/tcp
