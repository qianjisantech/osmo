...
import (
	"bytes"
	"github.com/qianjisantech/yl-cwhsea-gbs-gosmo-agent/internal/capture"
	"github.com/qianjisantech/yl-cwhsea-gbs-gosmo-agent/internal/tcp"
	"github.com/qianjisantech/yl-cwhsea-gbs-gosmo-agent/proto"
	"io/ioutil"
	"net"
	"net/http"
	"net/http/httptest"
